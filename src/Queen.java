...
/**
    ...
    {
        if((Math.abs(super.location.GetRow()-newLocation.GetRow())==Math.abs(super.location.GetCol()-newLocation.GetCol())) || ((super.location.GetRow()==newLocation.GetRow()) && super.location.GetCol()!=newLocation.GetCol()) || ((super.location.GetRow()!=newLocation.GetRow()) && super.location.GetCol()==newLocation.GetCol()) ){
